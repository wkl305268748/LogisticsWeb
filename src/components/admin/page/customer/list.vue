...
<script>
    import { CustomerList,CustomerMoney,deleteCustomer,CustomerPassword } from '@/api/user';
    ...
    export default {
        ...
        methods: {
            ...
            money(){
                ...
                CustomerMoney(this.moneyForm.id,this.moneyForm).then(response => {
                    this.$message({
                        type: 'success',
                        message: '充值成功!'
                    });
            ...
            password(){
                ...
                CustomerPassword(this.passwordForm.id,this.passwordForm).then(response => {
                    this.$message({
                        type: 'success',
                        message: '重置成功!'
                    });
            ...
            createData() {
                this.$router.push('/admin/home/customer/add');
            }
        },
        filters: {
            time: function (value) {
