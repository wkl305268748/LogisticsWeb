        ...
        <el-row style="margin-top: 30px">
            <el-col :span="5">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
                    ...
                    <el-form-item>
                        <el-button-group>
                            <el-button type="success" icon="upload" @click="contract_download">下载合同</el-button>
                            <el-button type="warning" icon="document" @click="contract_print">打印合同</el-button>
                        </el-button-group>
                    </el-form-item>
                </el-form>
            </el-col>
            <el-col :span="18" :offset="1">
                <iframe id="pdf_frame" frameborder="0" width="100%" height="800"></iframe>
            </el-col>
        </el-row>
...
<script>
    ...
    import { getOrder,editContractOrder } from '@/api/order';
    ...
    import "pdfmake/build/vfs_fonts";
        ...
        export default {
            ...
            methods: {
                ...
                getBody(order){
                    var bodyarry = [];
                    bodyarry.push(['运单号', order.orderCustomer.order_number ,'下单时间',this.day(order.orderCustomer.time)]);
                    ...
                    bodyarry.push(['承运司机', order.driver.name, '联系方式', order.driver.phone]);
                    bodyarry.push(['承运车辆', order.car.plate, '车型', order.car.type]);
                        ...
                        content: [
                            ...
                            { text: '第二条、 运费及结算', style: 'h1'},
                            {
                                table: {
                                    widths: [100, '*'],
                                    body: [
                                        ['保险', order.orderCustomer.safes + ' 元'],
                                        ['运费', order.orderCustomer.freight + ' 元'],
                                        ['合计金额', order.orderCustomer.total + ' 元']
                                    ]
                                }
                            },
