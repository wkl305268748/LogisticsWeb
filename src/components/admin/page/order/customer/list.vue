    ...
    <el-row>
        <el-row>
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>客户下单</el-breadcrumb-item>
            </el-breadcrumb>
        </el-row>
        ...
        <el-row style="margin-top: 10px">
            <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
                ...
                <el-table-column label="下单人">
                    <template scope="scope">
                        <div style="margin-top:10px;margin-bottom: 10px">
                            <p>账户：{{scope.row.user.username}}</p>
                            <el-tag type="primary">{{scope.row.userInfo.company}}</el-tag>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column
...
<script>
    import { getOrderListByCustomer } from '@/api/order';
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                getOrderListByCustomer(this.listQuery).then(response => {
