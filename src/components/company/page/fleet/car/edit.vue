<template>
    <el-row v-loading.body="listLoading" element-loading-text="正在提交，请稍后...">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>修改车辆</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-col style="margin-top: 50px">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                ...
                <el-form-item style="margin-top: 30px" >
                    <el-button type="success" @click="submitForm('ruleForm')">确定修改</el-button>
                </el-form-item>
...
<script>
    import { editCar,getCar } from '@/api/car';
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        editCar(this.ruleForm,this.id).then(response => {
