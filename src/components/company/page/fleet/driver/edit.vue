<template>
    <el-row v-loading.body="listLoading" element-loading-text="正在提交，请稍后...">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>修改司机</el-breadcrumb-item>
        </el-breadcrumb>
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="手机号" prop="phone">
                            <el-input v-model="ruleForm.phone" placeholder="司机APP客户端登录用户名" :disabled="true"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
<script>
    import { getDriver,editDriver } from '@/api/driver';
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                getDriver(this.id).then(response => {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        editDriver(this.id,this.ruleForm).then(response => {
