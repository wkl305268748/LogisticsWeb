                    ...
                    <el-card class="box-card" :body-style="{ padding: '0px' }">
                        <el-row>
                            ...
                            <el-col :span="16" style="padding: 10px">
                                <p>总订单数：</p>
                                <p style="margin-top:10px; font-size:25px;"><router-link to="/customer/home/order" style="color:#50bfff">{{all.order_all}}</router-link></p>
                            </el-col>
                        </el-row>
                    </el-card>
                </el-col>
...
<script>
    import { getCustomerAll,getCustomerOrderDay7 } from '@/api/order/count.js'
    ...
    export default {
        ...
        methods:{
            initAll(){
                ...
                getCustomerAll(this.request).then(response => {
            ...
            initOrderDay7(){
                getCustomerOrderDay7(this.request).then(response => {
